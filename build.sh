...
docker build  --squash -t dockerhub.suntekcorps.com:8443/suntek/$BASE_IMAGE_PROJECT:$BASE_IMAGE_VERSION --build-arg base_image_project=$BASE_IMAGE_PROJECT --build-arg  base_image_version=$BASE_IMAGE_VERSION .
